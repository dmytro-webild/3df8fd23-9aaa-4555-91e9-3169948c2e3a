...
export const metadata: Metadata = {
  title: "Roast & Toast | Premium Specialty Coffee in Al Aziziyah, Riyadh",  description: "4.9★ rated specialty coffee shop inside Ali Bin Ali Hospital. Premium coffee, dine-in, takeaway & delivery. Open until 3 AM. SAR 1-20.",  keywords: "specialty coffee Riyadh, best coffee Al Aziziyah, late night coffee shop, premium coffee near hospital, affordable specialty coffee",  robots: {
    index: true,
    follow: true,
  },
  metadataBase: new URL("https://roastandtoast.com"),
  alternates: {
    canonical: "https://roastandtoast.com"},
  openGraph: {
    title: "Roast & Toast - Specialty Coffee",    description: "Discover our 4.9★ rated specialty coffee in Al Aziziyah. Premium quality, cozy vibes, open until 3 AM.",    url: "https://roastandtoast.com",    siteName: "Roast & Toast",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/barista-work-coffee-shop_158595-2333.jpg",        alt: "Specialty coffee at Roast & Toast"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Roast & Toast - Premium Specialty Coffee",    description: "4.9★ rated coffee shop. Inside Ali Bin Ali Hospital. Open until 3 AM.",    images: ["http://img.b2bpic.net/free-photo/barista-work-coffee-shop_158595-2333.jpg"],
  },
};
